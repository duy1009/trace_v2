...
parser.add_argument("-i", "--image", type=str, default=["/home/hungdv/tcgroup/Clone_project/table_reconstruct_api/img_test"], nargs="+")
parser.add_argument("-c", "--config_file", type=str, required=False)
parser.add_argument("-m", "--trained_model", default="/home/hungdv/tcgroup/Clone_project/trace/weights/trace_wtw.pth", type=str,help="Trained model")
